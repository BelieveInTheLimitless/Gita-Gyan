...
fun getEnglishChapters() : List<Chapter>{
    return listOf(
        Chapter(
            ...
            chapterId = "1",
            chapterName = "Arjun Vishada Yoga",
        ...
        Chapter(
            chapterLanguage = "English",
            chapterId = "4",
            chapterName = "Jnana Karmasanyas Yoga",
        ...
        Chapter(
            chapterLanguage = "English",
            chapterId = "8",
            chapterName = "Akshar Brahma Yoga",
        ...
        Chapter(
            chapterLanguage = "English",
            chapterId = "9",
            chapterName = "Rajvidya Rajguhya Yoga",
        ...
        Chapter(
            chapterLanguage = "English",
            chapterId = "11",
            chapterName = "Vishwaroopa Darshan Yoga",
        ...
        Chapter(
            chapterLanguage = "English",
            chapterId = "18",
            chapterName = "Moksha Sanyas Yoga",
